...
#define CNTK_MODEL_VERSION_24 24 // ReduceElements: add keepDimension
...
protected:
    ...
    void ValidateUnaryReduce(bool isFinalValidationPass, bool keepDimension = false);
...
public:
                                       ...
                                       const ElemType* gapPadValue)
    {
        ...
        return Unpack(sampleShape, packedData, layout, nullSharedPtr, nullSharedPtr, batchMajor, gapPadValue);
    }
